...
namespace TrainingTrackerAPI.Migrations
{
    ...
    [Migration("20260303172954_InitialPostgres")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingTrackerAPI.Models.Auth.ApplicationUser", b =>
                {
                    b.Property<string>("Id").HasColumnType("text");
            ...
            modelBuilder.Entity("TrainingTrackerAPI.Models.Course", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    b.Property<string>("CourseName").IsRequired().HasColumnType("text");
                    b.Property<int>("Weight").HasColumnType("integer");
                    b.HasKey("Id");
                    b.ToTable("Courses");
                });

            modelBuilder.Entity("TrainingTrackerAPI.Models.Employee", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
            ...
            modelBuilder.Entity("TrainingTrackerAPI.Models.EmployeeCourse", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TrainingTrackerAPI.Models.Auth.ApplicationUser", null)
            ...
            modelBuilder.Entity("TrainingTrackerAPI.Models.EmployeeCourse", b =>
                {
                    b.HasOne("TrainingTrackerAPI.Models.Course", "Course")
                        .WithMany().HasForeignKey("CourseId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.HasOne("TrainingTrackerAPI.Models.Employee", "Employee")
                        .WithMany().HasForeignKey("EmployeeId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Course");
